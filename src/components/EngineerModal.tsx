...
import { Phone, Mail, MapPin, Building2, FileText, Mic } from 'lucide-react';
  ...
  return (
    <>
      ...
      <VoiceChat
        ...
        agent={{
          id: '89851696-c04f-41ee-a87d-cc307f0bd303', // Replace with actual engineer ID
          name: engineer.Name,
          avatar: getAvatarUrl(engineer.Name)
        }}
      />
    </>
  );
